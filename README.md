...
<h3 align="center">Highly motivated and skilled web developer with a Bachelor's degree in Computer Science and a passion for innovation. Proficient in HTML, CSS, JavaScript, VueJS, Vuex, React, Redux, RESTAPI, and Bootstrap, with certifications in HTML, CSS, JavaScript, and React. Practical experience gained through exciting projects and internships, including developing a MOOC recommendation system and a Todolist. Notable experience includes working on Orbits Clone, a large online travel agency. Always eager to learn and innovate with a dedication to excellence.</h3>
